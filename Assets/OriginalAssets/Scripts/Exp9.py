...
# モデル・テストファイルのリスト
model_names = ['Traj1', 'Traj2', 'Traj3', 'Traj4', 'Auto1', 'Auto2', 'Auto3', 'Auto4']

model_dir = 'Assets/OriginalAssets/File/Exp9_Model'
test_dir = 'Assets/OriginalAssets/File/Exp9_User'
